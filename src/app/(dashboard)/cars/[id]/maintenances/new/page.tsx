        ...
        <div className="lg:col-span-1 bg-white border border-slate-200 rounded-lg shadow-sm p-5 space-y-4 flex flex-col justify-between">
          ...
          <div className="border-t border-slate-100 pt-4 space-y-4">
            ...
            <button
              ...
              disabled={submitting}
              type="button"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-md text-xs transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-1.5 disabled:bg-blue-400"
            >
              {submitting ? (
                <>
